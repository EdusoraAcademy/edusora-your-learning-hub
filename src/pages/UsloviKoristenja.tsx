  ...
  <>
    ...
    <main className="pt-24 pb-16">
      <div className="container mx-auto px-4 max-w-3xl prose prose-sm dark:prose-invert">
        ...
        <p>Korištenjem platforme Edusora pristajete na ove uslove korištenja. Ako se ne slažete s bilo kojim dijelom, molimo vas da ne koristite naše usluge.</p>

        <h2>2. Korisnički račun</h2>
        <p>Za pristup kursevima potrebno je kreirati korisnički račun. Odgovorni ste za održavanje povjerljivosti vaših pristupnih podataka.</p>

        <h2>3. Intelektualno vlasništvo</h2>
        <p>Sav sadržaj na platformi, uključujući tekstove, video materijale, grafike i logotipe, zaštićen je autorskim pravima i vlasništvo je Edusora ili njenih partnera.</p>
        ...
        <p>Edusora ne garantuje specifične rezultate korištenjem naših kurseva. Sadržaj je informativnog i edukativnog karaktera.</p>
        ...
        <h2>8. Kontakt</h2>
        <p>Za sva pitanja u vezi s uslovima korištenja, kontaktirajte nas na kontakt@edusora.com.</p>
      </div>
    </main>
    <Footer />
  </>
